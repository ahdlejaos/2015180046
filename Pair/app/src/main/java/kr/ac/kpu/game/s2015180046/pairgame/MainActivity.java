 package kr.ac.kpu.game.s2015180046.pairgame;
 ...
 public class MainActivity extends AppCompatActivity {
     ...
     private int[] cards = {
             R.mipmap.fruita, R.mipmap.fruita, R.mipmap.fruitb, R.mipmap.fruitb,
             R.mipmap.fruitc, R.mipmap.fruitc, R.mipmap.fruitd, R.mipmap.fruitd,
             R.mipmap.fruite, R.mipmap.fruite, R.mipmap.fruitf, R.mipmap.fruitf,
             R.mipmap.fruitg, R.mipmap.fruitg, R.mipmap.fruith, R.mipmap.fruith,
             R.mipmap.fruiti, R.mipmap.fruiti, R.mipmap.fruitj, R.mipmap.fruitj,
     };
     ...
     private void askRestart() {
         ...
         builder.setNegativeButton(R.string.commom_no, null);
